...
Each workflow runs within its own subshell. This means that every command executed will run in the environment as it was left by the previous command. Using the following two commands as an example:

* @cd /Users/joshnesbitt/Desktop@
* @ls@

@ls@ will list all files on the desktop of @joshnesbitt@.
...
* Fixed issue in template regular expression where numerics were being ignored.
